...
S   ELECT NAIPE_ARCANO AS 'NAIPE', COUNT(NUMERO_ARCANO) AS 'QT' FROM DADOS JOIN USUARIO ON ID_USUARIO = FK_USUARIO JOIN ARCANOS ON NUMERO_ARCANO = FK_ARCANOS GROUP BY NAIPE_ARCANO;
